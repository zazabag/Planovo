...
const mobileLandingCss =
  '<link rel="stylesheet" href="/Planovo/assets/site-mobile-landing.css" media="(max-width: 768px)"/>';
if (!html.includes('site-mobile-landing.css')) {
  html = html.replace('site-mobile.css"/>', 'site-mobile.css"/>' + mobileLandingCss);
}
