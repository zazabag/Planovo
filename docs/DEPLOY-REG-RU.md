...
> Исторический способ публикации статического сайта через Reg.ru/FTP. Для PLN-170
> публичный контур `planovo.pro` должен обслуживаться отдельным nginx-контуром из
> `DEPLOY-PLANOVO-EXTERNAL.md`; старый общий proxy/rsync не использовать.
