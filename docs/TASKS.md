...
| TASK-31 | PLN-170: отдельный внешний контур planovo.pro + proxy KEMS | Codex | `codex/pln-170-planovo-external` | in-progress | [#30](https://github.com/zazabag/Planovo/pull/30) | deploy-доступ подтверждён; готовится отдельный Docker/Caddy-контур без изменений KEMS |
